...
new class extends Component {
    ...
    {
        $this->users = User::with(relations: 'roles')->get();
    }
        ...
        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <li class="py-3 sm:py-4">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="w-8 h-8 rounded-full" src="https://i.pravatar.cc/300" alt="User image">
                    </div>
                    ...
                    <div class="flex-1 min-w-0 ms-4">
                        <p class="text-sm text-right text-gray-500 truncate dark:text-gray-400">
                            {{ Str::ucfirst($user->roles->pluck('name')->join(', '))  }}
                        </p>

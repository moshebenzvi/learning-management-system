    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a href="{{ route('course.create') }}" type="button"
                class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add New Course</a>
        </h2>
    </x-slot>
                            ...
                            <li class="flex justify-between gap-x-6 py-5">
                                <div class="flex min-w-0 gap-x-4">
                                    ...
                                    <div class="min-w-0 flex-auto">
                                        <a href="{{ route('course.show', $course->id) }}"
                                            class="text-sm/6 font-semibold text-gray-900">{{ $course->title }}</a>
                                ...
                                <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                    ...
                                    <p class="mt-1 text-xs/5 text-gray-500">{{ $course->lessons_count }} Lesson <time
                                            datetime="2023-01-23T13:23Z">& {{ $course->enrolled_users_count }}
                                            User</time></p>
                                </div>
                            </li>
                        @endforeach

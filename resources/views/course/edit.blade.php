                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="/course/{{ $course->id }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="default-input" name="title" required
                                value="{{ $course->title }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="message" rows="4" name="description" required
                                ...
                                placeholder="Write your thoughts here...">{{ $course->description }}</textarea>
                        </div>
                        <a href="{{ route('course.show', $course->id) }}" type="button"
